...
const analyticsReport = () => {
  return (
   ...
   <CustomHead title="Viralon | Data-Driven Decisions with Reporting and 
Analytics "
   ...
   description="Viralon is the best data-driven digital marketing agency. Viralon brings you the power to transform raw data into actionable insights for your band." />
    ...
    <section id="marketings" className="content-marketing">
      ...
      <section
        ...
        style={{
          backgroundImage: "url(/images/hero-banners/reporting-analytics.jpg)",
          ...
          <div className="unlock-section-bx">
            ...
            <div className="pl-4">
              ...
              <p className="text-dark max-width100 mt-3">
                ...
                matter, the ability to measure and analyze your online presence is
                paramount. Welcome to the world of Reporting and Analytics, where
                Viralon Digital Services brings you the power to transform raw
                data into actionable insights that drive informed decisions and
              ...
              <div className="container mt-4 mob-container">
                <div className="significance-section1">
                  <div>
                    ...
                    />
                    <h3>
                      Data-Driven Decisions <i className="ri-arrow-right-line" />
                    </h3>
                    <p>
                  ...
                  <div>
                    ...
                    <p>
                      You can accurately measure the return on investment (ROI)
                      for your marketing campaigns, enabling you to allocate
                  ...
                  <div>
                    ...
                    />
                    <h3>
                      Continuous Improvement <i className="ri-arrow-right-line" />
                    </h3>
                    <p>
                      Regular analysis helps identify what's working and what's
                      not, allowing you to refine your strategies for better
                      results.
                    </p>
                  </div>
                  <div>
                    ...
                    />
                    <h3>
                      Competitive Advantage <i className="ri-arrow-right-line" />
                    </h3>
                    <p>
                      Understanding market trends and consumer behavior gives you
                  ...
                  <div>
                    ...
                    />
                    <h3>
                      Budget Optimization <i className="ri-arrow-right-line" />
                    </h3>
                    <p>
                      {" "}
                      Analytics reveal where your marketing budget is best spent,
            ...
            <div className="left-itemss">
              <div className="solid-left-itemsbxx">
                ...
                <div className="left-items11">
                  ...
                  <p>
                    {" "}
                    Our team comprises skilled data analysts and digital marketing
                    experts who understand the intricacies of online data.
                  </p>
                </div>
              </div>
            </div>
            <div className="left-itemss">
              <div className="solid-left-itemsbxx">
                ...
                <div className="left-items11">
                  ...
                  <p>
                    We tailor our reporting and analytics services to meet your
              ...
              <div className="solid-left-itemsbxx">
                ...
                <div className="left-items11">
                  ...
                  <p>
                    ...
                    improvements in your online presence and marketing strategies.
                  </p>
                </div>
              </div>
            </div>
