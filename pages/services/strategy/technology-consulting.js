...
const technologyConsulting = () => {
  return (
   ...
   <CustomHead title="Viralon | Technology Consulting for Business Efficiency "
      ...
      <div className="container1">
        <div className="row  bottom-p pt-5 padding-t max-width900 align-items-center">
          <p className="welcom-para ">
            ...
            Services, we understand that technology isn't just a tool - it's the
            diving force behind your business's growth and resilience. Our
            Technology Consulting services empower enterprises to navigate the
            ever-changing landscape of digital transformation with agility,
          ...
          <ul className="inforgrahic-block">
            ...
            <li className="bottom">
              ...
              <div>
                ...
                <p>
                  Once we grasp your unique needs, we define a clear roadmap for
                  your technology transformation.
                </p>
              </div>
            </li>
            <li className="top">
            ...
            <li className="bottom">
              ...
              <div>
                ...
                <p>
                  With your solutions taking shape, we seamlessly integrate them
            ...
            <li className="top">
              ...
              <div>
                ...
                <p>
                  The moment of truth arrives as your upgraded technology is put
                  to work.
                </p>
              </div>
            </li>
