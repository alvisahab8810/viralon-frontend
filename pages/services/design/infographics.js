...
const infographics = () => {
  return (
    <>
      <CustomHead
        title="Viralon | Creative Infographics for Effective Storytelling"
            ...
            <div className="de-hero1">
              <div className="de-hero-content">
                ...
                <p>
                  ...
                  informative but captivating. Our expert infographic designers
                  are dedicated to turning complex data and concepts into
                  visually compelling and easy-to-understand infographics that
                ...
                <div className="container mob-container   ">
                  <div className="our-methodology our-methodology1">
                    <div>
                      ...
                      <p>
                        {" "}
                        Infographics help you tell your story visually, making
                        it easier for your audience to grasp complex information
                        quickly.
                      </p>
                    </div>
                    <div>
                      ...
                      <p>
                        Visual content, including infographics, is more likely
                        to be shared on social media, leading to higher
                    ...
                    <div>
                      ...
                      <p>
                        Professionally designed infographics enhance your
                        brand's authority and credibility as a source of
      ...
      formats, ensuring they look sharp and professional across different media.</p>
              ...
              <div className="main-logo-bx">
                <div className="first-logo-bx">
                  <div className="first-active">
                    ...
                    <p>
                      {" "}
                      Transform complex data into visual insights that are easy
                      for your audience to digest.
                    </p>
                  </div>
                  <div>
                    <div className="de-icons1">
              ...
              <div className="ui-conent">
                <div className="first-logo-bx">
                  <div>
                    ...
                    <p>
                      {" "}
                      Craft marketing materials that grab attention and
                      communicate your products or services effectively.
                    </p>
                  </div>
                  <div className="first-active">
                    <div className="de-icons1">
        ...
        <section className="logo-footer">
          <div className="container">
            ...
            <p className="text-dark text-center max-width100 mt-3">
              Unlock the power of visual communication with professionally
              designed infographics. Trust Viralon Digital Services to create
              infographics that not only convey information but also engage your
              audience and drive results.
            </p>
            <p className="text-dark text-center max-width100 mt-5">
              Contact us today to discuss your infographic design project, and
              let's transform your data and ideas into captivating visual
