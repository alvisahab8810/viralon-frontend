...
const WhoWeAre = () => {
  return (
    <>
      <CustomHead
        title="Viralon | Who We Are | Best Digital Marketing Agency in India "
          ...
          <div className="row flex-wrap-reverse align-items-center">
            <div className="col-md-6 para-size">
              ...
              <p>
                ...
                digital excellence. Our team is composed of young and
                enthusiastic individuals guided by visionary management, and
                together, we are dedicated to helping businesses thrive in the
                digital landscape. We offer a comprehensive range of services,
                including full-stack digital marketing solutions, digital
                product development, cloud solutions, and innovative design
                services. With a deep commitment to delivering results, we work
                tirelessly to help you navigate the complexities of the digital
                world, ensuring your brand stands out and succeeds. Join us on
                this exciting journey to digital success, where your goals
                become our mission.
              </p>
            </div>
              ...
              <a href="#">
                <div className="wg-box-content-overlay">
                  ...
                  <p>
                    ...
                    driving force behind our success. We relentlessly seek
                    inventive solutions, pushing the boundaries of what's
                    possible in the digital world. We are committed to staying
                    at the forefront of technology and pioneering new paths to
                    excellence.
                  </p>
                </div>
                <img
              ...
              <a href="#">
                <div className="wg-box-content-overlay">
                  ...
                  <p>
                    ...
                    actions and their outcomes, holding ourselves responsible
                    for delivering on our promises. We believe that
                    accountability breeds trust, and we strive to earn and
                    maintain the trust of our clients and partners.{" "}
                  </p>
                </div>
                <img
                  className="wg-box-content-image"
              ...
              <a href="#">
                <div className="wg-box-content-overlay">
                  ...
                  <p>
                    ...
                    persistently tackle challenges head-on, never backing down
                    from adversity. We believe that determination is the key to
                    overcoming obstacles, achieving goals, and continuously
                    evolving in the digital realm.
                  </p>
                </div>
                <img
                  className="wg-box-content-image"
              ...
              <a href="#">
                <div className="wg-box-content-overlay">
                  ...
                  <p>
                    ...
                    with unwavering determination, persistently pursuing
                    solutions even when obstacles arise. Our resilience in the
                    face of adversity empowers us to overcome hurdles and
