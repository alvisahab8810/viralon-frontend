...
const TravelIndustries = () => {
  ...
  <CustomHead title="Viralon | Innovative Solutions for Travel Industry Success"
  ...
  <section id="banking-finance">
    ...
    >
      <img src="/images/industries/travel/banner1.png" className="f-label" />
      <div className="hero-img1">
        <div className="hero-content1">
          ...
          <p>
            ...
            compass guiding success. At Viralon Digital Services, we recognize
            the ever-evolving nature of the industry and are committed to
            delivering groundbreaking solutions that propel growth, efficiency,
    ...
    <section className="container1 ">
      <div id="exTab1">
        ...
        <div className="tab-content clearfix">
          ...
          <TravelSlider  sliderShow={sliderShow}
        ...
        <p className="para mt-5 margin-top-15 padding-bottom-15">
          {" "}
          In a rapidly evolving Travel Industry, Viralon Digital Services stands
          as a travel innovator, harnessing technology to redefine marketing
          strategies and steer success. From personalized experiences to
          cutting-edge technology solutions, Viralon is your companion in
          shaping the future of travel. Embark on the journey of innovation with
          Viralon today and unlock the boundless potential within the Travel
          Industry.
        </p>
      </div>
    </section>
