...
const ItIndustries = () => {
  ...
  return (
    <>
      <CustomHead
        title="Viralon | IT Industry | Grow Your IT Company with Viralon"
        ...
        >
          ...
          <div className="hero-img2">
            <div className="hero-content1">
              ...
              <p>
                In the ever-evolving landscape of the IT industry, innovation is
                the driving force that shapes businesses and technologies. At
                Viralon Digital Services, we recognize the dynamic nature of the
                sector and are dedicated to delivering transformative solutions
                that propel growth, efficiency, and technological advancement.
              </p>
            </div>
        ...
        <section className="container1 ">
          <div id="exTab1">
            ...
            <div className="tab-content clearfix">
              <ItSlide sliderShow={sliderShow} setSliderShow={setSliderShow} />
            </div>
