...
const RealEstateIndustries = () => {
  ...
  return (
   ...
   <CustomHead title="Viralon | Maximize Your Real Estate Opportunities with 
Viralon"
   ...
   description="In the Real Estate Industry, Viralon stands as a beacon of innovation, reshaping property transactions and enhancing customer experiences." /> 
    ...
    <section id="banking-finance">
      ...
      >
        <img src="/images/industries/real-estate/banner.png" className="r-label" />
        <div className="hero-img1">
          <div className="hero-content1">
            ...
            <p>
              ...
              innovative solutions that revolutionize property transactions,
              enhance customer experiences, and promote overall real estate
              well-being.
            </p>
          </div>
      ...
      <section className="container1 ">
        <div id="exTab1">
          ...
          <div className="tab-content clearfix">
            <RealStateSlide sliderShow={sliderShow}
              setSliderShow={setSliderShow}/>
            </div>
          <p className="para mt-5 margin-top-15 padding-bottom-15">
            In the dynamic realm of Real Estate, Viralon Digital Services stands
            as a beacon of innovation, reshaping property transactions and
            enhancing customer experiences. From digital property listings to
            cutting-edge virtual property tours, Viralon is your partner in
            embracing the digital evolution of real estate. Join hands with
            Viralon today and embark on a journey of transformation that enriches
            lives and drives real estate success.
          </p>
        </div>
      </section>
