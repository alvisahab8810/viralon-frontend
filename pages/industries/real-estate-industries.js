...
import RealStateSlide from "../../components/RealStateSlide";
...
const RealEstateIndustries = () => {
  ...
  return (
    <>
      <CustomHead
        title="Viralon | Maximize Your Real Estate Opportunities with 
        Viralon"
        keywords="Viralon, Digital Marketing Agency, Real Estate Industry"
        description="In the Real Estate Industry, Viralon stands as a beacon of innovation, reshaping property transactions and enhancing customer experiences."
      />
      ...
      <section id="banking-finance">
        ...
        >
          <img
            src="/images/industries/real-estate/banner.png"
            className="r-label"
          />
          <div className="hero-img1">
            <div className="hero-content1">
              <h1 className=" pt-0 text-dark font-size-28">
                Transforming Real Estate with Innovative
                <span className="text-gold"> Digital Solutions</span>
              </h1>
              <p>
                In the ever-evolving landscape of Real Estate, Viralon Digital
                Services takes center stage as a catalyst for change. We
                understand the dynamic nature of this industry and are dedicated
                to providing innovative solutions that revolutionize property
                transactions, enhance customer experiences, and promote overall
                real estate well-being.
              </p>
            </div>
            <div className="stick-img1">
              <img src="/images/industries/real-estate/banner1.png" />
            </div>
          </div>
        ...
        <section className="container1 ">
          <div id="exTab1">
            ...
            <p className="para mt-5 margin-top-15 padding-bottom-15">
              In the dynamic realm of Real Estate, Viralon Digital Services
              stands as a beacon of innovation, reshaping property transactions
              and enhancing customer experiences. From digital property listings
              to cutting-edge virtual property tours, Viralon is your partner in
              embracing the digital evolution of real estate. Join hands with
              Viralon today and embark on a journey of transformation that
              enriches lives and drives real estate success.
            </p>
          </div>
        </section>
