...
const HealthcareAndWellness = () => {
  ...
  return (
    <>
      <CustomHead
        title="Viralon | Experienced Team in Healthcare & Wellness 
        Industry"
          ...
          <div className="hero-img1">
            <div className="hero-content1">
              ...
              <p>
                ...
                Viralon Digital Services takes center stage as a catalyst for
                change. We understand the dynamic nature of this industry and
                are dedicated to providing innovative solutions that enhance
                patient care, streamline operations, and promote overall
                well-being.
              </p>
            </div>
        ...
        <section className="container1 ">
          <div id="exTab1">
                    ...
                    <div className="col-md-6 tab-listbx1">
                      <div className="z-index">
                        ...
                        <p className="text-white">
                          ...
                          patient care and well-being. Some noteworthy
                          innovations and products include
                        </p>
                      </div>
                    </div>
                              ...
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    ...
                                    empower individuals to monitor their health
                                    and well-being in real-time, promoting
                                    proactive self-care.
                                  </p>
                                </div>
                              </li>
                            ...
                            >
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    Advanced telemedicine platforms enable
                                    remote diagnosis, consultations, and
                                    treatment, ensuring accessible healthcare
                                    services.
                                  </p>
                                </div>
                              </li>
                              ...
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    ...
                                    health conditions, allowing for early
                                    intervention
                                  </p>
                                </div>
                              </li>
                            ...
                            >
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    Mobile applications and AI-driven tools
                  ...
                  <div className=" row banking-bx">
                    <div className="col-md-6 tab-listbx1">
                      <div className="z-index">
                        ...
                        <p className="text-white">
                          {" "}
                          Viralon's innovative tech solutions are tailored to
                          the unique needs of the Healthcare and Wellness
                          industry
                        </p>
                      </div>
                    </div>
                            ...
                            >
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    Tailored mobile and web applications that
                                    cater to specific healthcare needs, such as
                            ...
                            >
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    Robust telemedicine solutions that enable
                              ...
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    ...
                                    patient data management, ensuring easy
                                    access to medical records and enhancing
                                    patient care.
                                  </p>
                                </div>
                              </li>
                              ...
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    ...
                                    monitor and manage their health and
                                    wellness, including fitness tracking, diet
                                    planning, and symptom tracking.
                                  </p>
                                </div>
                              </li>
                            </div>
                            ...
                            >
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    Solutions to enhance patient engagement
                                    through personalized messaging, appointment
                                    reminders, and educational content delivery.
                                  </p>
                                </div>
                              </li>
                            </div>
                            ...
                            >
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    AI-powered chatbots for instant patient
                                    support, answering common queries, and
                                    guiding patients through their healthcare
                                    journey.
                                  </p>
                                </div>
                              </li>
                              ...
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    ...
                                    regulations and standards, such as ICD-10
                                    coding and Meaningful Use requirements.
                                  </p>
                                </div>
                              </li>
                            </div>
                            ...
                            >
                              <li className="rel-industry">
                                ...
                                <div className="industry-overlay">
                                  ...
                                  <p>
                                    Remote patient monitoring systems for
            ...
            <p className="para mt-5 margin-top-15 padding-bottom-15">
              ...
              experiences to cutting-edge technological solutions, Viralon is
              your partner in embracing the digital evolution of healthcare.
              Join hands with Viralon today and embark on a journey of
              transformation that enriches lives and drives success.
            </p>
          </div>
        </section>
