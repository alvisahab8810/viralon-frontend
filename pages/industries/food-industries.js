...
const FoodIndustries = () => {
  ...
  return (
    <>
    <CustomHead title=" Viralon | Boost Your Food Industry Presence with Viralon's 
Solutions"
      ...
      >
        ...
        <div className="hero-img1">
          <div className="hero-content1">
            ...
            <p>
              In the dynamic realm of the Food Industry, innovation is the recipe
              for success. At Viralon Digital Services, we recognize the evolving
              needs of the industry and are dedicated to delivering revolutionary
              solutions that drive growth, efficiency, and customer satisfaction
            </p>
          </div>
      ...
      <section className="container1 ">
        <div id="exTab1">
          ...
          <div className="tab-content clearfix">
            <FoodSlider sliderShow={sliderShow}
          ...
          <p className="para mt-5 margin-top-15 padding-bottom-15">
            ...
            Digital Services emerges as a pioneering force, skillfully wielding
            innovation to reshape marketing approaches and pave the path to
            triumph. From branding that emphasizes nutrition to revolutionary
            technological solutions, Viralon becomes your steadfast ally in
            shaping the destiny of the culinary realm. Take the decisive step to
            partner with Viralon today, and immerse yourself in the delectable
            essence of innovation that defines the future of the Food Industry
          </p>
        </div>
      </section>
