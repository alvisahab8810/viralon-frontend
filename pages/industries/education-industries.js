...
const EducationIndustries = () => {
  ...
  return (
    <>
      <CustomHead
        title="Viralon | Witness Viralon's Creative Achievements |  
          Portfolio"
      ...
      <section id="banking-finance">
        ...
        >
          <img
            src="/images/industries/education/banner1.png"
            className="e-label"
          />
          <div className="hero-img1">
            <div className="hero-content1">
              ...
              <p>
                ...
                to providing innovative solutions that enhance learning
                experiences, streamline educational operations, and promote
        ...
        <section className="container1 ">
          <div id="exTab1">
            ...
            <p className="para mt-5  margin-top-15 padding-bottom-15">
              In the dynamic realm of Education, Viralon Digital Services stands
              as a beacon of innovation, reshaping educational strategies and
              enhancing student well-being. From personalized learning
              experiences to cutting-edge technological solutions, Viralon is
              your partner in embracing the digital evolution of education. Join
              hands with Viralon today and embark on a journey of transformation
              that enriches lives and drives educational success.
            </p>
          </div>
        </section>
