...
export default function IndexPage({ data }) {
  return (
    ...
    <CustomHead title="Viralon | Best Digital Marketing Agency For Revenue Growth"
     keywords="Viralon, Digital Marketing Agency" 
     description="Viralon is the best digital marketing agency in India for revenue growth. Elevate your online presence with our expert strategies and innovative solutions." />
      <Header />
      {/* Social Icons */}
